...
object AdPutJob {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sparkConf = new SparkConf().setAppName(AdPutJob.getClass.getSimpleName)
    ...
    ssc.checkpoint("checkpoint-ad-put")

    countAdPut(kafkaStream)
  ...
  def countAdPut(dStream: DStream[(String, String)]): Unit = {
